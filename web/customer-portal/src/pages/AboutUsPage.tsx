  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">About FoodDelivery</h1>
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          FoodDelivery is your trusted partner in bringing delicious meals right to your doorstep. 
          Founded in 2023, we've been connecting hungry customers with their favorite local restaurants, 
          ensuring quick, reliable, and satisfying delivery experiences.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
          ...
          <div className="text-gray-600 dark:text-gray-300">Restaurant Partners</div>
        </div>
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md text-center">
          ...
          <div className="text-gray-600 dark:text-gray-300">Deliveries Made</div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">contact@fooddelivery.com</p>
              </div>
            </div>
          </div>
        </div>
